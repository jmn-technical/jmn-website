...
import openSchools from '../../assets/data/campuses/openSchools';

const OpenSchool = () => {
  const [searchTerm, setSearchTerm] = useState('');
  const [filterType, setFilterType] = useState('all');

  const campuses =  openSchools
    ...
    <div className="min-h-screen bg-gray-50 ">
      ...
      <Image
        ...
        <div className="absolute inset-0 flex items-center justify-center text-center px-4 mt-10 md:mt-0">
          <div>
            <h1 className="text-3xl md:text-4xl font-bold text-white mb-4">OPEN SCHOOLS</h1>
